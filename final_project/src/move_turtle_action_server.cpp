...
class MoveTurtleActionServer : public rclcpp::Node
{
public:
    MoveTurtleActionServer() : Node("move_turtle_action_server"), pose_received_(false),
        loop_freq_(100)
    {
        // Declare parameters
        ...
        pose1_sub_ = this->create_subscription<turtlesim::msg::Pose>("/" + turtle_name_ + "/pose", 10,
            std::bind(&MoveTurtleActionServer::callbackPose1, this, _1), options);
        ...
        move_turtle_server_ = rclcpp_action::create_server<MoveTurtle>(
            this,
            "move_turtle",
            std::bind(&MoveTurtleActionServer::goal_callback, this, _1, _2),
            std::bind(&MoveTurtleActionServer::cancel_callback, this, _1),
            std::bind(&MoveTurtleActionServer::handle_accepted_callback, this, _1),
...
int main(int argc, char **argv)
{
    ...
    auto node = std::make_shared<MoveTurtleActionServer>();
